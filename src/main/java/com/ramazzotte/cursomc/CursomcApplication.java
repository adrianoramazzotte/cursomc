...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat7 = new Categoria(null, "outros7");
		Categoria cat8 = new Categoria(null, "outros8");
		Categoria cat9 = new Categoria(null, "outros9");
		Categoria cat10 = new Categoria(null, "outros10");
		...
		categoriaRepository.saveAll(Arrays.asList(cat1, cat2,cat9,cat3,cat4,cat5,cat6,cat7,cat8,cat10));
